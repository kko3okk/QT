...
定義 Criterial\_list中的 Criterial存放變數的名稱 , 後續會在 XML &  plugin\_class 取用會有很大的關係
...
假如criteria元件需要動態取值 , 就會在此區塊定義Function名稱 , 以及如何取得
